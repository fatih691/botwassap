...
/////////////////
const BotName = 'BOT RAILFANS☄'; 
const instagram = 'https://instagram.com/fansbeaconcreamdansans'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@fansbeaconcreamdansans')
